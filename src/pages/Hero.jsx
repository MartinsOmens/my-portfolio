...
const Hero = () => {
  return (
    <div className="min-h-[90vh]">
      ...
      {/* === BIO / INFO SECTION === */}
      <section className="mt-10 mb-20 px-6 max-w-7xl mx-auto flex flex-col gap-8 text-white font-display">
        <div>
          <h2 className="text-4xl md:text-6xl font-bold mb-2">I am a Web Developer</h2>
